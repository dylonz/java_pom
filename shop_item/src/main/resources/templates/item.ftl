...
<head>
    ...
    <script type="text/javascript" src="http://localhost:8085/js/islogin.js" ></script>
</head>
<body>
...
<div class="shop_goods_bd clear">
    ...
    <div class="shop_goods_show">
        <div class="shop_goods_show_left">
            ...
            <div id="preview">
                <div class=jqzoom id="spec-n1" onClick="window.open('/')"><img src="${path + goods.gimage}" width="350" height="350">
                </div>
                <div id="spec-n5">
